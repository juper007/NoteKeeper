...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_INFO = "com.example.v_mipark.notekeeper.NOTE_INFO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mIsNewNote) {
            displayNote(spinner_coureses, textNoteTitle, textNoteText);
        }
    }
